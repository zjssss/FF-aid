...
SYMPTOM_DIC_PATH = '/Users/pengfei/Desktop/medical/model/symptomsDic.txt'
...
class Diagnoser():
    def __init__(self, description = None, symptoms = None,
        ...
        self.diseaseItemProerties = ['name','otherName', 'department','description', 'position','reason', 
